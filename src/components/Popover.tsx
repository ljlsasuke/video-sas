    ...
    <div className="relative inline-block" ref={containerRef}>
      ...
      {visible && (
        <div
          ref={contentRef}
          {...getContentProps()}
          className={`absolute z-50 w-fit transform rounded-lg bg-white p-3 shadow-lg transition-all duration-200 ease-in-out ${getPlacementStyle()} ${animationClass} ${overlayClassName}`}
        >
          {title && (
